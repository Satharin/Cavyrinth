<?php 
	...
	if($_SERVER['REQUEST_METHOD']=='GET'){
		...
		$sql = "SELECT Items.name, Item_stat.value AS armor, IFNULL(Attributes.name, 'none') AS attribute, IFNULL(Attributes.value, '0') AS value, IFNULL(Stats.name, 'none') AS immunity, IFNULL(Item_immunities.bonus, '0') AS 'bonus%', weight FROM Items 
